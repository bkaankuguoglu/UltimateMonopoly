 ...
 *  @version   1.0
 */
public class Advance2NearestRailroad extends Card{

	/**
	 * Constructor for Advance2NearestRailroad class. 
	 * 
	 ...
	 * 
	 */
	public Advance2NearestRailroad(String cardName, int typeID, int cardID,
			boolean kpable) {
	...
	/**
	 * Player advances to the nearest railroad track.
	 * 
	 * @param p the player who plays the card
	 * @param g the game instance that is being played
	 * @requires nothing
	 * @modifies p
	 * @effects Player p advanced to the nearest railroad track.
	 * 
	 */
	@Override
