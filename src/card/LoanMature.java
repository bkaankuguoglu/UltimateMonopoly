 ...
 *  @version   1.0
 */
public class LoanMature extends Card {

	/**
	 * Constructor for LoanMature Class. 
	 * 
	 ...
	 * 
	 */
	public LoanMature(String cardName, int typeID, int cardID, boolean kpable) {
		super(cardName, typeID, cardID, kpable);
		// TODO Auto-generated constructor stub
	}
	
	/**
	 * Player collects $150 from the bank.
	 * 	 
	 * @param p the player who plays the card
	 * @param g the game instance that is being played
	 * @requires nothing
	 * @modifies p
	 * @effects Player receives $150.
	 * 
	 */
	@Override
