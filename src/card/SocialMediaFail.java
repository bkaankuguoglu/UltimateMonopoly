...
public class SocialMediaFail extends Card {
	...
	/**
	 * Constructor for SocialMediaFail Class. 
	 * 
	 ...
	 * 
	 */
	public SocialMediaFail(String cardName, int typeID, int cardID,
			boolean kpable) {
	...
	/**
	 * Player pays each other player $50 to restore good PR.
	 * 
	 * @param p the player who plays the card
	 * @param g the game instance that is being played
	 * @requires nothing
	 * @modifies p g
	 * @effects Player pays each other player $50.
	 * 
	 */
	@Override
