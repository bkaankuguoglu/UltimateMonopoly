 ...
 *  @version   1.0
 */
public class GoBackSpace extends Card {
	
	/**
	 * Constructor for GoBackSpace class. 
	 * 
	 ...
	 * 
	 */
	public GoBackSpace(String cardName, int typeID, int cardID, boolean kpable) {
		super(cardName, typeID, cardID, kpable);
		// TODO Auto-generated constructor stub
	}

	/**
	 * Player goes back one space
	 * 	 
	 * @param p the player who plays the card
	 * @param g the game instance that is being played
	 * @requires nothing
	 * @modifies p g
	 * @effects Player moves back one space.
	 * 
	 */
	@Override
	public void applyCard(Player p, Game g) {
		...
		p.arriveDirectly2Square(p.getLocation().getPrSq(), g);
	}
